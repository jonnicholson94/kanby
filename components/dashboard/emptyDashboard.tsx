    ...
    return (
        <>
            ...
            <div className="h-auto w-full flex items-center justify-center mt-[100px] flex-col">
                ...
                <p className="h-auto xs:w-[95%] md:w-[700px] text-[20px] mt-[20px] text-center">Get started adding a task by clicking the button below</p>
                <button className="h-[40px] px-[20px] bg-primaryCta text-ctaText font-bold flex items-center justify-center rounded-sm mt-[30px]">
