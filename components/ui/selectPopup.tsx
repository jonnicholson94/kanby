...
export default function SelectPopup({ current, options, handleChange }: Props) {
    ...
    return (
        <Select.Root onValueChange={handleUpdate}>
            ...
            <Select.Trigger className="mr-[10px]">
                <div className="h-[35px] px-[10px] flex items-center justify-center border border-border rounded-sm">
            ...
            <Select.Portal>
                <Select.Content position="popper" sideOffset={5}>
                    <Select.Viewport className="h-auto flex items-center justify-center flex-col bg-primaryBg border border-border rounded-md p-[10px]">
                        { options.map(o => {
                            return (
                                <Select.Item key={o.content} value={o.content} className="h-[35px] w-full px-[10px] flex items-center justify-start cursor-pointer hover:bg-hover rounded-sm">
